...
export function PlayerShip({ x, y, rotation, aimRotation, shipClass, isShieldActive }: PlayerShipProps) {
  return (
    <div
    ...
    >
      <div className="relative -translate-x-1/2 -translate-y-1/2 grid place-items-center z-10">
        ...
        >
            <div style={{ filter: 'drop-shadow(0 0 8px hsl(var(--primary)))' }}>
                <ShipModel shipClass={shipClass} isPlayer />
            </div>
        </motion.div>
      </div>
    </div>

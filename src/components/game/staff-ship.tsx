      ...
      <div className="relative -translate-x-1/2 -translate-y-1/2">
        ...
        <div
          style={{
            ...
            filter: isTargeted ? `drop-shadow(0 0 8px hsl(${isAlly ? '210 100% 50%' : '240 5% 80%'}))` : 'none'
          }}
        >
          <ShipModel shipClass="Mineur" isAlly={isAlly} />
        </div>

        {/* UI elements (do not rotate) */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          {/* Health bar */}
          <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-1.5 bg-gray-600 rounded-full overflow-hidden border border-gray-800">
              <div
